...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.satellites_ccsds_viterbi_0 = satellites.hier.ccsds_viterbi()
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/dogg/Downloads/tm_stagin_grc/qpsk/data/Rx_data/tx_out.cfile', False, 0, 0)
        ...
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.satellites_ccsds_viterbi_0, 0))
        ...
        self.connect((self.satellites_ccsds_viterbi_0, 0), (self.blocks_stream_to_tagged_stream_1, 0))
